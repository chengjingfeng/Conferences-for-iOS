...
**Conferences** is the best way to watch the latest and greatest videos from your favourite developer conferences for free on your iOS device. Either search specifically for conferences, talks, speakers or topics or simply browse through the catalog - you can add talks to your watchlist to save for later, favourite or continue watching where you left off.
...
If you have any ideas how to improve the app or you wish yourself a new feature you can submit an pull request or create an issue [here](https://github.com/zagahr/Conferences-for-iOS/issues).
...
If you encounter any bugs please create an issue [here](https://github.com/zagahr/Conferences-for-iOS/issues) and be as descriptive as possible.
